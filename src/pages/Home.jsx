...
const Home = () => {
  ...
  return (
    ...
    <div className='bg-white mt-2 px-4 md:px-16 lg:px-24'> 
      <div className='container mx-auto py-8 flex flex-col md:flex-row space-x-2'>
        <div className='w-full md:w-3/12'>
            ...
            <div className='w-full md:w-9/12 mt-8 md:mt-0 h-96 relative'>
              ...
              <div className='absolute top-16 left-8'>
                <p className='text-gray-600 mb-4'>Made By Poonam</p>
                <h2 className='text-3xl font-bold'>WELCOME TO MYSTORE</h2>
